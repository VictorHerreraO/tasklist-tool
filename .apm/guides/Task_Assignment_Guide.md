...
- **Format:** Use the exact template provided in your .agent/workflows/apm-3-initiate-implementation.md instructions.
...
[Manager fills this section with section §7 content guidance, including explicit command references for Debug/Research delegations (.agent/workflows/apm-8-delegate-debug.md or .agent/workflows/apm-7-delegate-research.md)]
```
...
- **Debug Delegation**: Reference .agent/workflows/apm-8-delegate-debug.md
- **Research Delegation**: Reference .agent/workflows/apm-7-delegate-research.md  
