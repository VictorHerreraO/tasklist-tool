...
**Content Definition:**
- If flagged in §4.1, first add an ad-hoc delegation step: "Ad-Hoc Delegation – <purpose>" (optional ref to .agent/workflows/apm-7-delegate-research.md or .agent/workflows/apm-8-delegate-debug.md), then continue
...
- Present options as defined in .agent/workflows/apm-1-initiate-setup.md §2:
